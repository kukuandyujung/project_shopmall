...
<!-- Mirrored from themewagon.github.io/aroma/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Jun 2023 06:56:15 GMT -->
            ...
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item active submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="singleblog.jsp">Blog Details</a></li>
                </ul>
							</li>
							<li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                          ...
                          <div class="col-md-9">
                              <div class="blog_post">
                                  ...
                                  <div class="blog_details">
                                      ...
                                      <a class="button button-blog" href="singleblog">View More</a>
                                  </div>
                              </div>
                          </div>
                      </article>
                              ...
                              <div class="blog_post">
                                  ...
                                  <div class="blog_details">
                                      ...
                                      <p>MCSE boot camps have its supporters and its detractors. Some people do not understand
                                          why you should have to spend money on boot camp when you can get the MCSE study
                                          materials yourself at a fraction.</p>
                                      <a href="singleblog.jsp" class="button button-blog">View More</a>
                                  </div>
                              </div>
                          </div>
                      </article>
...
<!-- Mirrored from themewagon.github.io/aroma/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Jun 2023 06:56:21 GMT -->
</html>