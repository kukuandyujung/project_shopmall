      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index" class="site_title">Gentelella Alela!</a>
          </div>
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="index2">Dashboard2</a>
                    </li>
                    <li><a href="index3">Dashboard3</a>
                    </li>
                  </ul>
                </li>
                <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="form">General Form</a>
                    </li>
                    <li><a href="form_advanced">Advanced Components</a>
                    </li>
                    <li><a href="form_validation">Form Validation</a>
                    </li>
                    <li><a href="form_wizards">Form Wizard</a>
                    </li>
                    <li><a href="form_upload">Form Upload</a>
                    </li>
                    <li><a href="form_buttons">Form Buttons</a>
                    </li>
                  </ul>
                </li>
                <li><a><i class="fa fa-desktop"></i> UI Elements <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="general_elements">General Elements</a>
                    </li>
                    <li><a href="media_gallery">Media Gallery</a>
                    </li>
                ...
                <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="tables_dynamic">Table Dynamic</a>
                    </li>
                  </ul>
                </li>
                <li><a><i class="fa fa-bar-chart-o"></i> Data Presentation <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <li><a href="chartjs2">Chart JS2</a>
                    </li>
                    <li><a href="morisjs">Moris JS</a>
                    </li>
                    <li><a href="echarts">ECharts </a>
                    </li>
                    <li><a href="other_charts">Other Charts </a>
                    </li>
                  </ul>
                </li>
              </ul>
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-bug"></i> Additional Pages <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="e_commerce">E-commerce</a>
                    </li>
                    <li><a href="e_commerce_backend">E-commerce Backend</a>
                    </li>
                    <li><a href="projects">Projects</a>
                    </li>
                    <li><a href="project_detail">Project Detail</a>
                    </li>
                ...
                <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="page_403">403 Error</a>
                    </li>
                    <li><a href="page_404">404 Error</a>
                    </li>
                    <li><a href="page_500">500 Error</a>
                    </li>
                    <li><a href="coming_soon">Coming Soon</a>
                    </li>
                    <li><a href="plain_page">Plain Page</a>
                    </li>
                    <li><a href="login">Login Page</a>
                    </li>
                    <li><a href="sign_up">SignUp Page</a>
                    </li>
                    <li><a href="pricing_tables">Pricing Tables</a>
                    </li>
        ...
        <body data-twttr-rendered="true">
          ...
          <script type="text/javascript">
            $(document).ready(function() {
              ...
              //    $('#reportrange span')(start.format('ll') + ' - ' + end.format('ll'));
              ...
              $('#reportrange span')('Date Filtering'); //moment().subtract(29, 'days').format('ll') + ' - ' + moment().format('ll')
