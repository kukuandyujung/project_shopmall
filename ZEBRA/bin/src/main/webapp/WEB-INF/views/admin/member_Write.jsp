      ...
      <%@ include file="top_common.jsp" %>      
        ...
        <div class="right_col" role="main">
            <div class="page-title">
				...
				<h1>회원 정보 등록</h1>
				<hr></hr>
				<form action="member_Write" name="write" method="post">
		            ...
		            <div class="option">
		            	<input type="button" value="작성완료" onclick="writeMtn()" style="font-size: 17px; margin-right: 6px;">	
