...
<div id="ieUser" style="display:none">
	<div class="iewrap">	
		<p class="img"><img src="../img/ico/ico_alert.gif" alt="알림" /></p>
		<p class="txt">IE버전이 낮아 홈페이지 이용에 불편함이 있으므로 <strong>IE9이상이나 다른 브라우저</strong>를 이용해 주세요. </p>
		<ul>
			<li><a href="http://windows.microsoft.com/ko-kr/internet-explorer/download-ie" target="_blank"><img src="../img/ico/ico_ie.gif" alt="IE 최신브라우저 다운" ></a></li>
			<li><a href="https://www.google.com/intl/ko/chrome/browser" target="_blank"><img src="../img/ico/ico_chrome.gif" alt="IE 최신브라우저 다운" ></a></li>
			<li><a href="http://www.mozilla.org/ko/firefox/new" target="_blank"><img src="../img/ico/ico_mozila.gif" alt="MOZILA 최신브라우저 다운" ></a></li>
			<li><a href="http://www.apple.com/safari" target="_blank"><img src="../img/ico/ico_safari.gif" alt="SAFARI 최신브라우저 다운" ></a></li>
			<li><a href="http://www.opera.com/ko/o/ie-simple" target="_blank"><img src="../img/ico/ico_opera.gif" alt="OPERA 최신브라우저 다운" ></a></li>		
		</ul>
		<p class="btn" onclick="msiehide();"><img src="../img/ico/ico_close.gif" alt="닫기" /></p>
	</div>
</div>
<!--//익스레이어팝업-->
...
<div id="wrap">
	...
	<div id="header">
		...
		<div id="snbBox">
			<h1><img src="../img/txt/logo.gif" alt="JARDIN SHOP" /></h1>
			<div id="quickmenu">
				<div id="mnaviOpen"><img src="../img/btn/btn_mnavi.gif" width="33" height="31" alt="메뉴열기" /></div>
				<div id="mnaviClose"><img src="../img/btn/btn_mnavi_close.gif" width="44" height="43" alt="메뉴닫기" /></div>
				<ul>
			...
			<div id="snb">
				...
				<div id="search">
					...
					<input type="image" src="../img/btn/btn_main_search.gif" width="23" height="20" alt="검색하기" />
				</div>
			</div>
		</div>
	</div>
		...
		<!-- product -->
			<div id="pDetail">
				...
				<div class="imgSlide">
					<div class="img">
						<ul>
							<li><img src="../img/img/sample_brand.jpg" alt="제품이미지" /></li>
							<li><img src="../img/img/sample_brand.jpg" alt="제품이미지" /></li>
							<li><img src="../img/img/sample_brand.jpg" alt="제품이미지" /></li>
						</ul>
					</div>
					...
					<div class="thum">
						<ul>
							<li><img src="../img/img/sample_brand.jpg" alt="썸네일 제품이미지" /></li>
							<li><img src="../img/img/sample_brand.jpg" alt="썸네일 제품이미지" /></li>
							<li><img src="../img/img/sample_brand.jpg" alt="썸네일 제품이미지" /></li>
						</ul>
					</div>
						...
						<ul>
							...
							<li>
								...
								<div>
									...
									<img src="../img/ico/ico_star.gif" alt="별점" />
									<img src="../img/ico/ico_star.gif" alt="별점" />
									<img src="../img/ico/ico_star_off.gif" alt="별점" />
								</div>
							</li>
						</ul>
					</div>
		...
		<!-- detail content -->
			<div id="detailContent">
				...
				<div class="detailInfo disnone">
					<img src="../img/img/sample_detail_info.jpg" class="web" alt="제품상세 정보" />
					<img src="../img/img/sample_detail_info_m.jpg" class="mobile" alt="제품상세 정보" />
				...
				<div class="goodsRelation disnone">
					...
					<div class="relationList">
						<ul>
							<li>
								<div class="img"><img src="../img/img/sample_relation_goods.jpg" alt="관련상품 이미지" /></div>
				...
				<!-- 포토 구매후기 -->
					<div class="imgListType">
						<ul>
							...
							<!-- List -->
							<li>
								<div class="img"><img src="../img/img/sample_epil.jpg" width="155" height="160" alt="" /></div>
								<div class="txt">
									<div class="subject">
									...
									<div class="headArea">
										<div class="subject">
											<a href="../event/password.html" class="passbtn">
												배송기간은 얼마나 걸리나요?
												<img src="../img/ico/ico_lock.gif" alt="비밀글" />
											</a>
										</div>
										<div class="writer">[ezlin****]</div>
										<div class="day">
...
$(document).ready(function() {
	...
	<div id="footerWrap">
		<div id="footer">
			...
			<div id="finfo">
				<div id="flogo"><img src="../img/txt/flogo.gif" alt="JARDIN THE COFFEE CREATOR, SINCE 1984" /></div>
				<address>
					<ul>
						<li>㈜쟈뎅</li>
						<li>대표자 윤영노</li>
				...
				<div id="inicis"><img src="../img/ico/ico_inicis.png" alt="이니시스 결제시스템" /></div>
			</div>
		</div>
	</div>
