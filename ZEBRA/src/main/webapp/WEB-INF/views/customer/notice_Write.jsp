	...
	<div id="container">
		<div id="outbox">		
			<div id="left">
				...
				<ul>				
					<li><a href="/customer/fqlList" id="leftNavi3">FAQ</span></a></li>		
			...
			<div id="contents">
				<div id="customer">
					<h2><strong>1:1문의</strong><span>지브라에 궁금하신 사항을 남겨주시면 답변해드립니다.</span></h2>
							...
							<form action = "/customer/notice_Write" name="faqFrm" method ="post" enctype="multipart/form-data" >
					<div class="checkMt">
						<table summary="분류, 제목, 상세내용, 첨부파일 순으로 궁금하신 점을 문의 하실수 있습니다." class="checkTable" border="1" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" name="ftitle" class="wlong" />
									</td>
								</tr>
								<tr>
									<th scope="row"><span>상세 내용</span></th>
									<td>
										<textarea name ="fcontent" class="tta"></textarea>
									</td>
								</tr>
								<tr>
