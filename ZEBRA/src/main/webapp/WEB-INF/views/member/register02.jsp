							...
							<table
								...
								<tbody>
									<tr>
										...
										<td>
											<li class="r10"><input type="text" name="MNAME "
												id="joinName" class="w134" /></li>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<ul class="pta">
												<li class="r10"><input type="password" name="MPASSWORD"
													id="joinPw" class="w134" /></li>
				...
				<div class="btnArea">
					<div class="bCenter">
						<ul>
							...
							<li><a style="cursor: pointer;" href="/member/register03"
								class="sbtnMini">가입하기</a></li>
						</ul>
					</div>
				</div>
				<!-- //Btn Area -->
